...
define('DB_NAME', getenv('RDS_DB_NAME') ?: 'agroconnect');
define('DB_USER', getenv('RDS_DB_USER') ?: 'root');
define('DB_PASS', getenv('RDS_DB_PASS') !== false ? getenv('RDS_DB_PASS') : '');
define('DB_CHAR', getenv('RDS_DB_CHAR') ?: 'utf8mb4');
...
// Strip script path if requests come through /folder/api.php/route
